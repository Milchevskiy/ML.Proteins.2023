This is the program to fit regression multi-output neural network for protein local structure 
prediction by protein blocks without reliancy to the evolutionary information (i.e. sequence alignments).
...
2. Put learn_Q16.dbs.tar.gz to the same directory as Learn_Q16.py script and unpack it:
...
3. If you want to learn from the scratch, delete following files:
   Q16_DATA_MODEL
   Q16_DATA_MODEL_FOR_CPU
   and set lr_start to 0.01 in Learn_Q16.py.
